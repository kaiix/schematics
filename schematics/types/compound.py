...
class MultiType(BaseType):
    ...
    def export_loop(self, shape_instance, field_converter, name_selector,
...
class ModelType(MultiType):
    ...
    def export_loop(self, model_instance, field_converter, name_selector,
                    role=None, print_none=False):
        """
...
class ListType(MultiType):
    ...
    def export_loop(self, list_instance, field_converter, name_selector,
                    role=None, print_none=False):
...
class DictType(MultiType):
    ...
    def export_loop(self, dict_instance, field_converter, name_selector,
                    role=None, print_none=False):
        """Loops over each item in the model and applies either the field
        transform or the multitype transform.  Essentially functions the same
        as `transforms.export_loop`.
